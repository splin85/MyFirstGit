...
int checkboard(void)
{
	puts("Board: LS1021ATWR\n");
        ...
        #define CONFIG_SYS_GPIO1_DIR 0x02300000
        #define CONFIG_SYS_GPIO1_DAT 0x02300008
        out_be32(CONFIG_SYS_GPIO1_DIR, in_be32(CONFIG_SYS_GPIO1_DIR) | 0x00002000);
        out_be32(CONFIG_SYS_GPIO1_DAT, in_be32(CONFIG_SYS_GPIO1_DAT) | 0x00002000);
#endif

#if defined(ABSM_CONFIG)
        #define CONFIG_SYS_GPIO4_DIR 0x02330000
        #define CONFIG_SYS_GPIO4_DAT 0x02330008
        out_be32(CONFIG_SYS_GPIO4_DIR, in_be32(CONFIG_SYS_GPIO4_DIR) | 0x00180000);
        out_be32(CONFIG_SYS_GPIO4_DAT, in_be32(CONFIG_SYS_GPIO4_DAT) | 0x00180000);
#endif
...
int board_eth_init(bd_t *bis)
{
	...
	SET_STD_TSEC_INFO(tsec_info[num], 3);
        tsec_info[num].flags |= TSEC_REDUCED;
	num++;
#endif
	if (!num) {
...
int board_early_init_f(void)
{
    ...
    /* select the gpio19 and gpio20 */
#if defined(ABSM_CONFIG)
        unsigned int val = in_be32(&scfg->qeioclkcr);
        out_be32(&scfg->qeioclkcr, val | 0x50000000);
#endif
