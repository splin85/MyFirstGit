...
{
    /* reset with externel watchdog add by splin */
#if defined(GSWA_CONFIG)
        #define CONFIG_SYS_GPIO1_DIR 0x02300000
        #define CONFIG_SYS_GPIO1_DAT 0x02300008
        out_be32(CONFIG_SYS_GPIO1_DIR, in_be32(CONFIG_SYS_GPIO1_DIR) | 0x00001000);
        out_be32(CONFIG_SYS_GPIO1_DAT, in_be32(CONFIG_SYS_GPIO1_DAT) & 0xffffefff);
#elif defined(ABSM_CONFIG)
        #define CONFIG_SYS_GPIO4_DIR 0x02330000
        #define CONFIG_SYS_GPIO4_DAT 0x02330008
        out_be32(CONFIG_SYS_GPIO4_DIR, in_be32(CONFIG_SYS_GPIO4_DIR) | 0x00000800);
        out_be32(CONFIG_SYS_GPIO4_DAT, in_be32(CONFIG_SYS_GPIO4_DAT) & 0xfffff7ff);
#else
