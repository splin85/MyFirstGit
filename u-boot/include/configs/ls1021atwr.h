...
#define CONFIG_SYS_FSL_PBL_RCW	board/freescale/ls1021atwr/ls102xa_rcw_sd_ifc_gswa.cfg
#elif defined(ABSM_CONFIG)
#define CONFIG_SYS_FSL_PBL_RCW	board/freescale/ls1021atwr/ls102xa_rcw_sd_ifc_absm.cfg
#else
...
/* Add nand boot by splin */
#ifdef CONFIG_NAND_BOOT
#if defined(GSWA_CONFIG)
#define CONFIG_SYS_FSL_PBL_RCW  board/freescale/ls1021atwr/ls102xa_rcw_nand_ifc_gswa.cfg
#elif defined(ABSM_CONFIG)
#define CONFIG_SYS_FSL_PBL_RCW  board/freescale/ls1021atwr/ls102xa_rcw_nand_ifc_absm.cfg
#else
#define CONFIG_SYS_FSL_PBL_RCW  board/freescale/ls1021atwr/ls102xa_rcw_nand_ifc.cfg
#endif
...
/* NAND Flash Definitions added by splin */ 
...
#else
#define CONFIG_BOOTARGS    "root=/dev/ram0 rw ramdisk_size=256000 mem=2047M console=ttyS0,115200 rootfstype=ext4"
#define CONFIG_BOOTCOMMAND "nand read 0x83000000 0x600000 0xa00000; "    \
                           "nand read 0x88000000 0x1200000 0x5000000; "  \
                           "nand read 0x8f000000 0x01000000 0x00100000;" \
                           "bootm 0x83000000 0x88000000 0x8f000000"

#define CONFIG_EXTRA_ENV_SETTINGS     \
        "initrd_high=0xffffffff\0"    \
        "fdt_high=0xffffffff\0"       \
        "eth2addr=F8:09:23:00:00:00\0"\
        "serverip=192.168.1.11\0"     \
        "ipaddr=192.168.1.12\0"
#endif
...
#define CONFIG_AUTOBOOT_DELAY_STR "\x03"
#define CONFIG_AUTOBOOT_PROMPT "Hit ctrl+c to stop autoboot: %2d \n"
